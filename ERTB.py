...
bio_prompt = """
Ты находишься в групповом чате, твоя задача составлять мини-био о каждом человеке на основе его общения. 
...
Не пиши "участник обсуждения", только уникальные факты про человека
"""
